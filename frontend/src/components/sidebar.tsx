...
const Outpass_Outing = lazy(() => import("./outpass&outing"));
const Resetpassword = lazy(() => import("../pages/resetpass"));
const RequestComp = lazy(() => import("./request-component"));
const Student = lazy(() => import("../pages/student"));
const GradeHub = lazy(() => import("../pages/GradeHub"));
const Error = lazy(() => import("../App"));

// Re-export enableOutingsAndOutpasses from Student
...
export default function Sidebar({ content }: MainContent) {
  ...
  // Handle sidebar collapse based on breakpoint (886px)
  useEffect(() => {
    const handleResize = () => {
  ...
  const contentMap = {
    outing: <Outpass_Outing request="outing" />,
    outpass: <Outpass_Outing request="outpass" />,
          ...
          {isLoading ? (
            ...
            <div className="text-white text-left flex items-center gap-2 -ml-2">
              <div
                ...
                } text-black rounded-full p-2 px-3 font-bold`}
              >
                {username.name
