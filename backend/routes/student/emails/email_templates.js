...
exports.passwordResetFailed = exports.passwordResetSuccess = exports.getOutingMailFormatForAdministration = exports.getOutingMailFormatForStudent = exports.getOutpassMailFormatForAdministration = exports.getOutpassMailFormatForStudent = void 0;
...
<body>
    <div class="container">
        ...
        <p>Your outpass request with ID: <strong>${(_a = outpass.outpass_details) === null || _a === void 0 ? void 0 : _a.id}</strong> is being sent to your Administration. You will be notified via email once it is approved or rejected.</p>
        <div class="details">
...
const getOutpassMailFormatForAdministration = (outpass, user) => {
    var _a, _b, _c, _d;
...
exports.getOutpassMailFormatForAdministration = getOutpassMailFormatForAdministration;
    ...
    const studentOutingEmailBody = `
                ...
                <body>
                    <div class="container">
                        ...
                        <p>Your outing request with ID: <strong>${(_a = outing.outing_details) === null || _a === void 0 ? void 0 : _a.id}</strong> is being sent to your Administration. You will be notified via email once it is approved or rejected.</p>
                        <div class="details">
...
const getOutingMailFormatForAdministration = (outing, user) => {
    var _a, _b, _c;
...
exports.getOutingMailFormatForAdministration = getOutingMailFormatForAdministration;
